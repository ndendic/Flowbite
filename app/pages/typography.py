...
typography = Div(
    H1("Typography"),
    P(cls=PT.lead)("Typography is the art and technique of arranging text to make it more appealing and readable. It involves selecting fonts, adjusting spacing, and using various techniques to create a visually pleasing and effective text layout."),
    P(cls=PT.lead)("This page demonstrates the typography components and styling options available in Fastbite, including headings, paragraphs, text sizing, spacing, weights, and semantic text elements. These tools provide a consistent approach to text styling across your application."),
    P(cls=PT.lead)("All typography components are designed to be responsive, accessible, and compatible with both light and dark themes. They follow semantic HTML practices while providing enhanced visual styling."),
...
H6("Heading 6"),""",
    ...
    H3("Bold"),
    P("Use the ", Code("bold"), " parameter to make the heading bold."),
    component_showcase(
            H1("Heading 1", bold=True),
            H2("Heading 2", bold=True),
            H3("Heading 3", bold=True),
            H4("Heading 4", bold=True),
            H5("Heading 5", bold=True),
            H6("Heading 6", bold=True),
            code="""H1("Heading 1", bold=True),
H2("Heading 2", bold=True),
H3("Heading 3", bold=True),
H4("Heading 4", bold=True),
H5("Heading 5", bold=True),
H6("Heading 6", bold=True),""",
    ...
    Br(),
    H3("Header link"),
    P("Use the ", Code("link"), " parameter to make the heading a link. This will also make the heading a link to the heading id."),
    component_showcase(
...
H6("Heading 6", link=True),""",
    ...
    component_showcase(
        P("This is a default paragraph style with appropriate text color and spacing."),
        code="""P("This is a default paragraph style with appropriate text color and spacing.")""",
