...
component = Div(
    ...
    Ul(
        ...
        Li(
            A('Dashboard', href='#', cls='inline-block w-full p-4 bg-gray-50 border-r border-gray-200 dark:border-gray-700 hover:text-gray-700 hover:bg-gray-50 focus:ring-4 focus:ring-primary-300 focus:outline-none dark:hover:text-white dark:bg-gray-800 dark:hover:bg-gray-700'),
            cls='w-full focus-within:z-10'
        ),
        Li(
            A('Settings', href='#', cls='inline-block w-full p-4 bg-gray-50 border-r border-gray-200 dark:border-gray-700 hover:text-gray-700 hover:bg-gray-50 focus:ring-4 focus:ring-primary-300 focus:outline-none dark:hover:text-white dark:bg-gray-800 dark:hover:bg-gray-700'),
            cls='w-full focus-within:z-10'
        ),
        Li(
            A('Invoice', href='#', cls='inline-block w-full p-4 bg-gray-50 border-s-0 border-gray-200 dark:border-gray-700 rounded-e-lg hover:text-gray-700 hover:bg-gray-50 focus:ring-4 focus:outline-none focus:ring-primary-300 dark:hover:text-white dark:bg-gray-800 dark:hover:bg-gray-700'),
            cls='w-full focus-within:z-10'
        ),
