...
component = Div(
    ...
    component_showcase(
        Div(
            Button("Primary", cls=ButtonT.primary+"animate-pulse"),
...
Button("Purple Outline", cls=ButtonOutline.purple)""",
    ...
    P("Add visual interest with gradient backgrounds using ", Code("BgColor"), " gradient variants. These buttons use smooth color transitions for a modern look."),
    component_showcase(
        Div(
            Button("Primary Gradient", cls=BgColor.grad_primary),
            Button("Blue Gradient", cls=BgColor.grad_blue),
            Button("Green Gradient", cls=BgColor.grad_green),
            Button("Cyan Gradient", cls=BgColor.grad_cyan),
            Button("Teal Gradient", cls=BgColor.grad_teal),
            Button("Red Gradient", cls=BgColor.grad_red),
            cls="flex flex-wrap items-center gap-2 py-4"
        ),
        code="""Button("Primary Gradient", cls=BgColor.grad_primary),
Button("Blue Gradient", cls=BgColor.grad_blue),
Button("Green Gradient", cls=BgColor.grad_green),
Button("Cyan Gradient", cls=BgColor.grad_cyan),
Button("Teal Gradient", cls=BgColor.grad_teal),
Button("Red Gradient", cls=BgColor.grad_red)""",
    ...
    component_showcase(
        Div(
            Button("Purple to Blue", cls=BgColor.purple_blue),
            Button("Cyan to Blue", cls=BgColor.cyan_blue),
            Button("Green to Blue", cls=BgColor.green_blue),
            Button("Purple to Pink", cls=BgColor.purple_pink),
            Button("Pink to Orange", cls=BgColor.pink_orange),
            Button("Teal to Lime", cls=BgColor.teal_lime),
            Button("Red to Yellow", cls=BgColor.red_yellow),
            cls="flex flex-wrap items-center gap-2 py-4"
        ),
        code="""Button("Purple to Blue", cls=BgColor.purple_blue),
Button("Cyan to Blue", cls=BgColor.cyan_blue),
Button("Green to Blue", cls=BgColor.green_blue),
Button("Purple to Pink", cls=BgColor.purple_pink),
Button("Pink to Orange", cls=BgColor.pink_orange),
...
Button("Red to Yellow", cls=BgColor.red_yellow)""",
    ...
    P("Add visual interest with gradient backgrounds using ", Code("BgColor"), " gradient variants. These buttons use smooth color transitions with a shadow for a modern look."),
    component_showcase(
        Div(
            Button("Primary", cls=BgColor.grad_shadow_primary),
            Button("Blue", cls=BgColor.grad_shadow_blue),
            Button("Green", cls=BgColor.grad_shadow_green),
            Button("Cyan", cls=BgColor.grad_shadow_cyan),
            Button("Teal", cls=BgColor.grad_shadow_teal),
            Button("Lime", cls=BgColor.grad_shadow_lime),
            Button("Purple", cls=BgColor.grad_shadow_purple),
            Button("Pink", cls=BgColor.grad_shadow_pink),
            Button("Red", cls=BgColor.grad_shadow_red),
            cls="flex flex-wrap items-center py-4"
        ),
        code="""Button("Primary", cls=BgColor.grad_shadow_primary),
Button("Blue", cls=BgColor.grad_shadow_blue),
Button("Green", cls=BgColor.grad_shadow_green),
Button("Cyan", cls=BgColor.grad_shadow_cyan),
Button("Teal", cls=BgColor.grad_shadow_teal),
...
Button("Large Round Purple Outline", cls=ButtonOutline.purple, size=ButtonSize.lg, shape=Round.full)""",
    ...
    component_showcase(Div(
            Button(Icon("mail", cls='w-3 h-3 text-white me-2'),'Extra small',size=ButtonSize.xs),
            Button(Icon("mail", cls='w-3 h-3 text-white me-2'),'Small',size=ButtonSize.sm),
            Button(Icon("mail", cls='w-3.5 h-3.5 text-white me-2'),'Base'),
            Button(Icon("mail", cls='w-4 h-4 text-white me-2'),'Large',size=ButtonSize.lg,),
            Button(Icon("mail", cls='w-4 h-4 text-white me-2'),'Extra large',size=ButtonSize.xl),
            cls=(FlexT.block, FlexT.middle, "gap-2 py-4")
        ), 
        code="""Button(Icon("mail", cls='w-3 h-3 text-white me-2'),'Extra small',size=ButtonSize.xs),
Button(Icon("mail", cls='w-3 h-3 text-white me-2'),'Small',size=ButtonSize.sm),
Button(Icon("mail", cls='w-3.5 h-3.5 text-white me-2'),'Base'),
Button(Icon("mail", cls='w-4 h-4 text-white me-2'),'Large',size=ButtonSize.lg,),
Button(Icon("mail", cls='w-4 h-4 text-white me-2'),'Extra large',size=ButtonSize.xl),""", 
    ...
    P('Use the following examples to add a',A(Code('Icon'), href='/icons'),' inside the button either on the left or right side.'),
        component_showcase(Div(
        Button(Icon('shopping-cart',cls='w-3.5 h-3.5 me-2'),'Buy now'),
        Button('Choose plan',Icon('arrow-right',cls='w-3.5 h-3.5 ms-2')),
        cls=(FlexT.block, FlexT.middle, "gap-2 py-4")), 
        code="""Button(Icon('shopping-cart',cls='w-3.5 h-3.5 me-2'),'Buy now'),
    Button('Choose plan',Icon('arrow-right',cls='w-3.5 h-3.5 me-2'))""",
    ...
    component_showcase(Div(
            Button(Icon("arrow-right",cls='w-5 h-5')),
            Button(Icon("thumbs-up",cls='w-5 h-5'), cls=ButtonT.ghost),
            Button(Icon("heart",cls='w-5 h-5'), cls=ButtonOutline.red),    
            cls=(FlexT.block, FlexT.middle, "gap-2 py-4")
        ),
        code="""Button(Icon("arrow-right",cls='w-5 h-5')),
Button(Icon("thumbs-up",cls='w-5 h-5'), cls=ButtonT.ghost),
Button(Icon("heart",cls='w-5 h-5'), cls=ButtonOutline.red)""", 
