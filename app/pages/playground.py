...
header_controls = fh.Div(cls='w-full p-4 border border-gray-200 bg-gray-50 rounded-t-xl dark:border-gray-600 dark:bg-gray-700')(
    fh.Div(cls='grid grid-cols-3')(
        fh.Div(cls='col-span-2 sm:col-span-1')(
            fh.A(href='https://github.com/themesberg/flowbite/blob/main/content/components/tables.md', rel='noopener nofollow noreferrer', cls='inline-flex items-center justify-center h-9 mr-3 px-3 text-xs font-medium text-gray-900 bg-white border border-gray-200 rounded-lg focus:outline-none hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-2 focus:ring-gray-300 dark:focus:ring-gray-500 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700')(
        ...
        fh.Div(cls='items-center justify-center hidden col-span-1 space-x-2 sm:flex')(
            fh.Button(data_tooltip_target='table-striped-rows-example-full-screen-tooltip', cls='flex items-center justify-center w-9 h-9 text-xs font-medium text-gray-700 bg-white border border-gray-200 rounded-lg toggle-full-view hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-2 focus:ring-gray-300 dark:focus:ring-gray-500 dark:bg-gray-800 focus:outline-none dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700')(
            ...
            fh.Button(data_tooltip_target='table-striped-rows-example-mobile-tooltip', cls='flex items-center justify-center w-9 h-9 text-xs font-medium text-gray-700 bg-white border border-gray-200 rounded-lg toggle-mobile-view hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-2 focus:ring-gray-300 dark:focus:ring-gray-500 dark:bg-gray-800 focus:outline-none dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700')(
