...
# %% auto 0
__all__ = ['flowbite_hdrs', 'flowbite_ftrs', 'TextT', 'TextPresets', 'TextHeading', 'H1', 'H2', 'H3', 'H4', 'H5', 'H6',
           'CodeSpan', 'CodeBlock', 'P', 'Meter', 'ButtonColor', 'Round', 'ButtonSize', 'ButtonOutline', 'ButtonT',
           'Button', 'FlexT', 'ContainerSize', 'Container', 'Grid', 'DivFullySpaced', 'DivCentered', 'DivLAligned',
           'DivRAligned', 'DivVStacked', 'DivHStacked', 'Icon', 'DiceBearAvatar', 'PicSumImg', 'TabItem',
           'TabContainer']
...
def CodeSpan(*c, # Contents of CodeSpan tag (inline text code snippets)
    ...
    return fh.Div(fh.Code(*c, cls=(stringify(cls)), **kwargs))
