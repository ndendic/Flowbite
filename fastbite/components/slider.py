...
def SliderControls(
    ...
    span_cls:Enum|str|tuple='inline-flex items-center justify-center w-10 h-10 rounded-full bg-gray-50/30 dark:bg-gray-800/30 group-hover:bg-gray-50/50 dark:group-hover:bg-gray-800/60 group-focus:ring-4 group-focus:ring-white dark:group-focus:ring-gray-800/70 group-focus:outline-none', # Added span_cls
