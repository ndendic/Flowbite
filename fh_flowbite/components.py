...
# %% auto 0
__all__ = ['TextT', 'TextPresets', 'TextHeading', 'H1', 'H2', 'H3', 'H4', 'H5', 'H6', 'ButtonColor', 'ButtonShape', 'ButtonSize',
           'ButtonOutline', 'ButtonShadow', 'ButtonSocial', 'ButtonPayment', 'ButtonGradientOutline', 'Button', 'FlexT']
...
class ButtonColor(VEnum):
    ...
    # Base styles
    default = "bg-primary-700 hover:bg-primary-800 dark:bg-primary-600 dark:hover:bg-primary-700  text-white focus:ring-primary-300 dark:focus:ring-primary-800"
    ...
    dark = "bg-gray-800 hover:bg-gray-900 dark:bg-gray-800 dark:hover:bg-gray-700 dark:border-gray-700 text-white focus:ring-gray-300 dark:focus:ring-gray-700"
    light = "bg-white border border-gray-300 hover:bg-gray-100 dark:bg-gray-800 dark:text-white dark:border-gray-600 dark:hover:bg-gray-700 dark:hover:border-gray-600 text-gray-900 focus:ring-gray-200 dark:focus:ring-gray-700"
...
class ButtonShadow(VEnum):
    """Button with colored shadow variants"""
    blue = "bg-gradient-to-r from-blue-500 via-blue-600 to-blue-700 hover:bg-gradient-to-br dark:focus:ring-blue-800 shadow-blue-500/50 dark:shadow-blue-800/80 text-white focus:ring-blue-300 dark:focus:ring-blue-800"
    green = "bg-gradient-to-r from-green-400 via-green-500 to-green-600 hover:bg-gradient-to-br dark:focus:ring-green-800 shadow-green-500/50 dark:shadow-green-800/80 text-white focus:ring-green-300 dark:focus:ring-green-800"
    cyan = "bg-gradient-to-r from-cyan-400 via-cyan-500 to-cyan-600 hover:bg-gradient-to-br dark:focus:ring-cyan-800 shadow-cyan-500/50 dark:shadow-cyan-800/80 text-white focus:ring-cyan-300 dark:focus:ring-cyan-800"
    teal = "bg-gradient-to-r from-teal-400 via-teal-500 to-teal-600 hover:bg-gradient-to-br dark:focus:ring-teal-800 shadow-teal-500/50 dark:shadow-teal-800/80 text-white focus:ring-teal-300 dark:focus:ring-teal-800"
    lime = "bg-gradient-to-r from-lime-200 via-lime-400 to-lime-500 hover:bg-gradient-to-br dark:focus:ring-lime-800 shadow-lime-500/50 dark:shadow-lime-800/80 text-gray-900 focus:ring-lime-300 dark:focus:ring-lime-800"
    red = "bg-gradient-to-r from-red-400 via-red-500 to-red-600 hover:bg-gradient-to-br dark:focus:ring-red-800 shadow-red-500/50 dark:shadow-red-800/80 text-white focus:ring-red-300 dark:focus:ring-red-800"
    pink = "bg-gradient-to-r from-pink-400 via-pink-500 to-pink-600 hover:bg-gradient-to-br dark:focus:ring-pink-800 shadow-pink-500/50 dark:shadow-pink-800/80 text-white focus:ring-pink-300 dark:focus:ring-pink-800"
    purple = "bg-gradient-to-r from-purple-500 via-purple-600 to-purple-700 hover:bg-gradient-to-br dark:focus:ring-purple-800 shadow-purple-500/50 dark:shadow-purple-800/80 text-white focus:ring-purple-300 dark:focus:ring-purple-800"

class ButtonSocial(VEnum):
    """Social media button variants"""
    facebook = "bg-[#3b5998] hover:bg-[#3b5998]/90 focus:ring-[#3b5998]/50 dark:focus:ring-[#3b5998]/55 text-white"
    twitter = "bg-[#1da1f2] hover:bg-[#1da1f2]/90 focus:ring-[#1da1f2]/50 dark:focus:ring-[#1da1f2]/55 text-white"
    github = "bg-[#24292F] hover:bg-[#24292F]/90 focus:ring-[#24292F]/50 dark:focus:ring-gray-500 dark:hover:bg-[#050708]/30 text-white"
    google = "bg-[#4285F4] hover:bg-[#4285F4]/90 focus:ring-[#4285F4]/50 dark:focus:ring-[#4285F4]/55 text-white"
    apple = "bg-[#050708] hover:bg-[#050708]/90 focus:ring-[#050708]/50 dark:focus:ring-[#050708]/50 dark:hover:bg-[#050708]/30 text-white"

class ButtonPayment(VEnum):
    """Payment button variants"""
    metamask = "bg-white hover:bg-gray-100 border border-gray-200 focus:ring-gray-100 dark:focus:ring-gray-600 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700 text-gray-900 dark:text-white"
    opera = "bg-white hover:bg-gray-100 border border-gray-200 focus:ring-gray-100 dark:focus:ring-gray-600 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700 text-gray-900 dark:text-white"
    bitcoin = "bg-[#FF9119] hover:bg-[#FF9119]/80 focus:ring-[#FF9119]/50 dark:hover:bg-[#FF9119]/80 dark:focus:ring-[#FF9119]/40 text-white"
    paypal = "bg-[#F7BE38] hover:bg-[#F7BE38]/90 focus:ring-[#F7BE38]/50 dark:focus:ring-[#F7BE38]/50 text-gray-900"
    apple_pay = "bg-[#050708] hover:bg-[#050708]/80 focus:ring-[#050708]/50 dark:hover:bg-[#050708]/40 dark:focus:ring-gray-600 text-white"
    visa = "bg-white hover:bg-gray-100 border border-gray-200 focus:ring-gray-100 dark:focus:ring-gray-800 dark:bg-white dark:border-gray-700 dark:hover:bg-gray-200 text-gray-900 dark:text-gray-900"
    mastercard = "bg-white hover:bg-gray-100 border border-gray-200 focus:ring-gray-100 dark:focus:ring-gray-600 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700 text-gray-900 dark:text-white"
    ethereum = "bg-gray-100 hover:bg-gray-200 focus:ring-gray-100 dark:focus:ring-gray-500 text-gray-900"
    amex = "bg-[#2557D6] hover:bg-[#2557D6]/90 focus:ring-[#2557D6]/50 focus:outline-none dark:focus:ring-[#2557D6]/50 text-white"
...
def Button(*c: Union[str, FT],cls: Union[str, Enum]=ButtonColor.default, shape: Union[str, Enum]=ButtonShape.default, submit=True, **kwargs) -> FT: 
